...
export enum Page {
    ...
    BarkochbaStories = "barkochba/stories",
    BarkochbaAdmin = "barkochba/admin",
...
export const getNavUrl = {
    ...
    [Page.BarkochbaStories]: () => "/barkochba/stories",
    [Page.BarkochbaAdmin]: () => "/barkochba/admin",
...
export const getNavUrlTemplate = {
    ...
    [Page.BarkochbaStories]: getNavUrl[Page.BarkochbaStories](),
    [Page.BarkochbaAdmin]: getNavUrl[Page.BarkochbaAdmin](),
...
export const getNavUrlSimpleTitle = {
    ...
    [Page.BarkochbaStories]: getPageTitle("Barkochba - Történetek szerkesztése"),
    [Page.BarkochbaAdmin]: getPageTitle("Barkochba - Hozzáférések"),
